...
\begin{bnf*}
  ...
  \bnfprod{op\_unario}
    { + \bnfsp | \bnfsp - \bnfsp | \bnfsp ! \bnfsp | \bnfsp \# \bnfsp | \bnfsp ?}\\
...
\hspace{5mm}
- entero: Un numero entero entre 0 y 9.

\hspace{5mm}
- real: Un entero separado de otro entero por un punto (''.'')

\hspace{5mm}
- caracter: Cualquier elemento que pertenezca a la tabla ASCII.

\hspace{5mm}
- booleano: Puede ser o la cadena "verdadero" o la cadena "falso".

\hspace{5mm}
- listade <tipo_basico> : Es una lista formada por datos cuyo tipo viene en <tipo_basico>. Esos tipos son los cuatro explicados anteriormente.
