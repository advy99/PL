...
\begin{bnf*}
  ...
  \bnfprod{tipo}
    {\bnfpn{tipo\_basico}}\\
    \bnfmore{| \bnfsp "lista de " \bnfsp \bnfpd{tipo\_basico}}\\
  \bnfprod{tipo\_basico}
    {"entero"}\\
    \bnfmore{| \bnfsp "real"}\\
    \bnfmore{| \bnfsp "caracter"}\\
    \bnfmore{| \bnfsp "booleano"}\\
	\bnfprod{Sentencias}
  ...
  \bnfprod{sentencia\_repeat\_until}
    {"repeat" \bnfsp \bnfpn{Sentencia} \bnfsp "until" \bnfsp "(" \bnfpn{condicion} \bnfsp ");"}\\
  ...
  \bnfprod{secuencia\_caract}
    ...
    \bnfmore{| \bnfsp \bnfpn{expresion} \bnfsp \bnfpn{op\_ternario\_prim} \bnfsp \bnfpn{expresion} \bnfsp \bnfpn{op\_ternario\_seg} \bnfsp \bnfpn{expresion}}\\
  ...
  \bnfprod{op\_unario\_booleano}
    { \bnfsp "!"}\\
  \bnfprod{funcion}
    { \bnfpn{identificador} \bnfsp "(" \bnfsp \bnfpn{lista_const} \bnfsp ")"}\\
  \bnfprod{lista_const}
